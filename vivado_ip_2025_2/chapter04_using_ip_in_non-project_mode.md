...
- [Chapter 2: IP Basics](chapter02_ip_basics.md) — IP customization, output products, synthesis options
- [Chapter 3: Using Manage IP Projects](chapter03_using_manage_ip_projects.md) — Manage IP flow
