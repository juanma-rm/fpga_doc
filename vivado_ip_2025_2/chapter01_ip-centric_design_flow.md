...
| Method | Description |
|--------|-------------|
| **Managed IP Flow** | Customize IP and generate output products including a synthesized DCP. See [Chapter 3: Using Manage IP Projects](chapter03_using_manage_ip_projects.md) |
...
|---------------|-------------------|
| **Hardware, IP, and Platform Development** | [Chapter 2: IP Basics](chapter02_ip_basics.md), [Chapter 3: Using Manage IP Projects](chapter03_using_manage_ip_projects.md) |
| **System Integration and Validation** | [Chapter 2: Working with Debug IP](chapter02_ip_basics.md#working-with-debug-ip) |
...
| **IP Catalog** | Allows exploration of AMD plug-and-play IP and third-party IP-XACT-compliant IP. See [Chapter 2: IP Basics](chapter02_ip_basics.md) |
...
| **Out-Of-Context (OOC) Design Flow** | Creates a standalone synthesis run for generated output products, producing a DCP and `_ooc.xdc`. See [Chapter 2: Out-of-Context Flow](chapter02_ip_basics.md#synthesis-options-for-ip) |
