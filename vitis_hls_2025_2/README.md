...
### [Section I - Introduction to Vitis HLS](section1_introduction_intro.md)

- [What is High-Level Synthesis?](section1_introduction_intro.md#1-what-is-high-level-synthesis)
- [Supported Operating Systems & Licensing](section1_introduction_intro.md#2-supported-operating-systems--licensing)
- [Changed Behavior in v2025.2](section1_introduction_intro.md#3-changed-behavior-in-v20252)
- [Benefits of HLS](section1_introduction_intro.md#4-benefits-of-hls)
- [Introduction to Vitis HLS Components](section1_introduction_intro.md#5-introduction-to-vitis-hls-components)
- [Key Synthesis Concepts](section1_introduction_intro.md#6-key-synthesis-concepts)
- [Refactoring C++ Source Code for HLS](section1_introduction_intro.md#7-refactoring-c-source-code-for-hls)
- [Re-Architecting the Hardware Module](section1_introduction_intro.md#8-re-architecting-the-hardware-module)
- [Best Practices](section1_introduction_intro.md#9-best-practices)
- [Tutorials and Examples](section1_introduction_intro.md#10-tutorials-and-examples)

---

## Section II - Programmers Guide

### [Chapter 1 - Design Principles](chapter1_design_principles.md)

- [Introduction & Motivation](chapter1_design_principles.md#1-introduction--motivation)
- [Throughput and Performance](chapter1_design_principles.md#2-throughput-and-performance)
- [Architecture Matters: CPU vs FPGA](chapter1_design_principles.md#3-architecture-matters-cpu-vs-fpga)
- [Three Paradigms for Programmable Logic](chapter1_design_principles.md#4-three-paradigms-for-programmable-logic)
- [Combining the Three Paradigms](chapter1_design_principles.md#5-combining-the-three-paradigms)
- [Conclusion - A Prescription for Performance](chapter1_design_principles.md#6-conclusion--a-prescription-for-performance)
- [Best Practices](chapter1_design_principles.md#7-best-practices)

### [Chapter 2 - Abstract Parallel Programming Model for HLS](chapter2_abstract_parallel_programming.md)

- [The Abstract Parallel Programming Model](chapter2_abstract_parallel_programming.md#1-the-abstract-parallel-programming-model)
- [Channel Semantics: Blocking vs Non-Blocking](chapter2_abstract_parallel_programming.md#2-channel-semantics-blocking-vs-non-blocking)
- [Control-Driven vs Data-Driven TLP](chapter2_abstract_parallel_programming.md#3-control-driven-vs-data-driven-tlp)
- [Data-Driven TLP - hls::task](chapter2_abstract_parallel_programming.md#4-data-driven-tlp--hlstask)
- [Control-Driven TLP - Dataflow Pragma](chapter2_abstract_parallel_programming.md#5-control-driven-tlp--dataflow-pragma)
- [Dataflow Region Coding Style (WYSIWYG / Canonical)](chapter2_abstract_parallel_programming.md#6-dataflow-region-coding-style-wysiwyg--canonical)
- [Advanced Dataflow Features](chapter2_abstract_parallel_programming.md#7-advanced-dataflow-features)
- [Configuring Dataflow Memory Channels](chapter2_abstract_parallel_programming.md#8-configuring-dataflow-memory-channels)
- [Stream-of-Blocks (hls::stream_of_blocks)](chapter2_abstract_parallel_programming.md#9-stream-of-blocks-hlsstream_of_blocks)
- [Compiler-Created FIFO Types](chapter2_abstract_parallel_programming.md#10-compiler-created-fifo-types)
- [#pragma HLS stable](chapter2_abstract_parallel_programming.md#11-pragma-hls-stable)
- [Mixing Data-Driven and Control-Driven Models](chapter2_abstract_parallel_programming.md#12-mixing-data-driven-and-control-driven-models)
- [Summary: Choosing the Right TLP Model](chapter2_abstract_parallel_programming.md#13-summary-choosing-the-right-tlp-model)
- [Best Practices](chapter2_abstract_parallel_programming.md#14-best-practices)

### [Chapter 3 - Loops Primer](chapter3_loops_primer.md)

- [Why Loops Matter for HLS Performance](chapter3_loops_primer.md#1-why-loops-matter-for-hls-performance)
- [Pipelining Loops](chapter3_loops_primer.md#2-pipelining-loops)
- [Automatic Loop Pipelining](chapter3_loops_primer.md#3-automatic-loop-pipelining)
- [Rewinding Pipelined Loops](chapter3_loops_primer.md#4-rewinding-pipelined-loops)
- [Pipeline Types (STP / FRP / FLP)](chapter3_loops_primer.md#5-pipeline-types-stp--frp--flp)
- [Managing Pipeline Dependencies](chapter3_loops_primer.md#6-managing-pipeline-dependencies)
- [Removing False Dependencies](chapter3_loops_primer.md#7-removing-false-dependencies)
- [Unrolling Loops](chapter3_loops_primer.md#8-unrolling-loops)
- [Merging Loops](chapter3_loops_primer.md#9-merging-loops)
- [Working with Nested Loops](chapter3_loops_primer.md#10-working-with-nested-loops)
- [Working with Variable Loop Bounds](chapter3_loops_primer.md#11-working-with-variable-loop-bounds)
- [Best Practices](chapter3_loops_primer.md#12-best-practices)

### [Chapter 4 - Arrays Primer](chapter4_arrays_primer.md)

- [Mapping Software Arrays to Hardware Memory](chapter4_arrays_primer.md#1-mapping-software-arrays-to-hardware-memory)
- [Array Accesses and Performance](chapter4_arrays_primer.md#2-array-accesses-and-performance)
- [Array Partitioning](chapter4_arrays_primer.md#3-array-partitioning)
- [Array Reshaping](chapter4_arrays_primer.md#4-array-reshaping)
- [Arrays on the Interface](chapter4_arrays_primer.md#5-arrays-on-the-interface)
- [Initializing and Resetting Arrays](chapter4_arrays_primer.md#6-initializing-and-resetting-arrays)
- [Implementing ROMs](chapter4_arrays_primer.md#7-implementing-roms)
- [C Simulation with Large Arrays](chapter4_arrays_primer.md#8-c-simulation-with-large-arrays)
- [Best Practices](chapter4_arrays_primer.md#9-best-practices)

### [Chapter 5 - Functions Primer](chapter5_functions_primer.md)

- [Top-Level Function and Hierarchy](chapter5_functions_primer.md#1-top-level-function-and-hierarchy)
- [Function Inlining](chapter5_functions_primer.md#2-function-inlining)
- [Function Pipelining](chapter5_functions_primer.md#3-function-pipelining)
- [Function Instantiation](chapter5_functions_primer.md#4-function-instantiation)
- [Best Practices](chapter5_functions_primer.md#5-best-practices)

### [Chapter 6 - Data Types](chapter6_data_types.md)

- [Standard C/C++ Types](chapter6_data_types.md#1-standard-cc-types)
- [Floats and Doubles](chapter6_data_types.md#2-floats-and-doubles)
- [Composite Data Types](chapter6_data_types.md#3-composite-data-types)
- [Type Qualifiers](chapter6_data_types.md#4-type-qualifiers)
- [Arbitrary Precision Integer Types (ap_int)](chapter6_data_types.md#5-arbitrary-precision-integer-types-ap_int)
- [Arbitrary Precision Fixed-Point Types (ap_fixed)](chapter6_data_types.md#6-arbitrary-precision-fixed-point-types-ap_fixed)
- [Arbitrary Precision Floating-Point Library (ap_float)](chapter6_data_types.md#7-arbitrary-precision-floating-point-library-ap_float)
- [Global Variables](chapter6_data_types.md#8-global-variables)
- [Pointers](chapter6_data_types.md#9-pointers)
- [Best Practices](chapter6_data_types.md#10-best-practices)

### [Chapter 7 - Unsupported C/C++ Constructs](chapter7_unsupported_constructs.md)

- [Synthesis Requirements](chapter7_unsupported_constructs.md#1-synthesis-requirements)
- [System Calls](chapter7_unsupported_constructs.md#2-system-calls)
- [Dynamic Memory Allocation](chapter7_unsupported_constructs.md#3-dynamic-memory-allocation)
- [Pointer Limitations](chapter7_unsupported_constructs.md#4-pointer-limitations)
- [Recursive Functions](chapter7_unsupported_constructs.md#5-recursive-functions)
- [Standard Template Libraries (STL)](chapter7_unsupported_constructs.md#6-standard-template-libraries-stl)
- [Undefined Behaviors](chapter7_unsupported_constructs.md#7-undefined-behaviors)
- [Virtual Functions](chapter7_unsupported_constructs.md#8-virtual-functions)
- [Quick Reference Table](chapter7_unsupported_constructs.md#9-quick-reference-table)

### [Chapter 8: Interfaces of the HLS Design](chapter8_interfaces.md)

- [Interface Synthesis Overview](chapter8_interfaces.md#1-interface-synthesis-overview)
- [Vitis Kernel Flow Defaults](chapter8_interfaces.md#2-vitis-kernel-flow-defaults)
- [Vivado IP Flow Defaults](chapter8_interfaces.md#3-vivado-ip-flow-defaults)
- [M_AXI Interface](chapter8_interfaces.md#4-m_axi-interface)
- [S_AXILITE Interface](chapter8_interfaces.md#5-s_axilite-interface)
- [AXI4-Stream (AXIS) Interface](chapter8_interfaces.md#6-axi4-stream-axis-interface)
- [Aggregation and Disaggregation of Structs](chapter8_interfaces.md#7-aggregation-and-disaggregation-of-structs)
- [Block-Level Control Protocols](chapter8_interfaces.md#8-block-level-control-protocols)
- [Execution Modes](chapter8_interfaces.md#9-execution-modes)

### [Chapter 9: Best Practices for Designing with M_AXI Interfaces](chapter9_maxi_best_practices.md)

- [Overview and Goals](chapter9_maxi_best_practices.md#1-overview-and-goals)
- [Load-Compute-Store (LCS) Pattern](chapter9_maxi_best_practices.md#2-loadcomputestore-lcs-pattern)
- [Hardware Data Flow Mindset](chapter9_maxi_best_practices.md#3-hardware-data-flow-mindset)
- [Global Memory Access Strategy](chapter9_maxi_best_practices.md#4-global-memory-access-strategy)
- [Port Width Maximization](chapter9_maxi_best_practices.md#5-port-width-maximization)
- [Memory Resource Selection](chapter9_maxi_best_practices.md#6-memory-resource-selection)
- [Concurrent Port Configuration](chapter9_maxi_best_practices.md#7-concurrent-port-configuration)
- [Burst Length Configuration](chapter9_maxi_best_practices.md#8-burst-length-configuration)
- [Outstanding Requests Configuration](chapter9_maxi_best_practices.md#9-outstanding-requests-configuration)
- [Best Practices Summary](chapter9_maxi_best_practices.md#10-best-practices-summary)
