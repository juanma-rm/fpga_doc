...
Extract and convert a UG1399 chapter into structured, cross-linked markdown documentation. Output should be comprehensive, internally consistent, and well-organized.

---

## Input

**Chapter Number:** [only user input required]
...
- **Name Convention:** `ch<NUM>_<descriptive_title>.md`
- **Location:** `hls_summary/`
- **Format:** Markdown with proper heading hierarchy, tables, code blocks, links

### Document Structure

**All chapters should follow this consistent template:**
