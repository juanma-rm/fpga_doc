...
- [Chapter 17 — HLS Pragmas](../section04_vitis_hls_command_reference/ch17_hls_pragmas.md) — `INTERFACE`, `AGGREGATE`, `DISAGGREGATE` pragma reference
- [Chapter 19 — AXI4-Lite C Driver](../section05_vitis_hls_c_driver_reference/ch19_axi4lite_driver.md) — `s_axilite` driver API
