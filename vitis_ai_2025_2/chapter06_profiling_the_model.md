...
7. **Profile with `DEEPHI_PROFILING=1`** for custom OP profiling (see [Chapter 5](chapter05_deploying_and_running_the_model.md)).
...
- [Chapter 1 — Vitis AI Overview](chapter01_vitis_ai_overview.md) — Profiler in the Vitis AI tool chain
- [Chapter 4 — Compiling the Model](chapter04_compiling_the_model.md) — compiled XMODEL is what gets profiled
- [Chapter 5 — Deploying and Running the Model](chapter05_deploying_and_running_the_model.md) — VART runtime and custom OP profiling
