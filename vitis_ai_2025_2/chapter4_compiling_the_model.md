...
2. **Check operator support** before compiling — use the Inspector tool ([Chapter 3](chapter3_quantizing_the_model.md)) to identify unsupported operators early.
...
- [Chapter 1 — Vitis AI Overview](chapter1_vitis_ai_overview.md)
- [Chapter 2 — Optimizing the Model](chapter2_optimizing_the_model.md) — pruning before compilation
- [Chapter 3 — Quantizing the Model](chapter3_quantizing_the_model.md) — quantization is prerequisite to compilation
- [Chapter 5 — Deploying and Running the Model](chapter5_deploying_and_running_the_model.md) — VART runtime uses compiled XMODEL
- [Chapter 6 — Profiling the Model](chapter6_profiling_the_model.md) — profile compiled model performance
