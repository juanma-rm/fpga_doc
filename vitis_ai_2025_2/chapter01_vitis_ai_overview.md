...
1. **Optimize** — [Chapter 2: Optimizing the Model](chapter02_optimizing_the_model.md)
2. **Quantize** — [Chapter 3: Quantizing the Model](chapter03_quantizing_the_model.md)
3. **Compile** — [Chapter 4: Compiling the Model](chapter04_compiling_the_model.md)
4. **Deploy & Run** — [Chapter 5: Deploying and Running the Model](chapter05_deploying_and_running_the_model.md)
5. **Profile** — [Chapter 6: Profiling the Model](chapter06_profiling_the_model.md)
...
- See: [Chapter 2: Optimizing the Model](chapter02_optimizing_the_model.md)
...
- See: [Chapter 3: Quantizing the Model](chapter03_quantizing_the_model.md)
...
- See: [Chapter 4: Compiling the Model](chapter04_compiling_the_model.md)
...
- See: [Chapter 6: Profiling the Model](chapter06_profiling_the_model.md)
...
- See: [Chapter 5: Deploying and Running the Model](chapter05_deploying_and_running_the_model.md)
