...
- [Chapter 3 — Quantizing the Model](chapter3_quantizing_the_model.md) — quantization is prerequisite to deployment
- [Chapter 4 — Compiling the Model](chapter4_compiling_the_model.md) — XMODEL compilation for VART
- [Chapter 6 — Profiling the Model](chapter6_profiling_the_model.md) — profile deployed model performance
